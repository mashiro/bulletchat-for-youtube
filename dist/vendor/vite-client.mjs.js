import { HMRPort } from '../assets/crx-client-port.js';
import '../assets/webcomponents-custom-elements-z7FmG.js';
import './vite-env.mjs.js';
...
const socketHost = `${"localhost" || location.hostname}:${"3000"}`;
const socket = new HMRPort(`${socketProtocol}://${socketHost}`, 'vite-hmr');
const base = "/" || '/';
const messageBuffer = [];
